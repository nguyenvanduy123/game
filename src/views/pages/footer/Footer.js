  ...
  return (
    <footer className="footer-area footer-fixed bg-contain bottom-tab">
      ...
      <ul className="navbar-fixed-5 navbar-nav navbar-nav-f">
        ...
        <li className="nav-item  item ml-2"><Link className="icon_bottom icon_bottom3" to="/home"></Link></li>
        <li className="nav-item  item ml-2"><Link className="icon_bottom icon_bottom4" to="/historys"></Link></li>
      </ul>
